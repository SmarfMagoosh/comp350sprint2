/** @license
 * DayPilot Pro for JavaScript 2023.1.5488
...
export declare class DayPilotScheduler extends React.Component<DayPilot.SchedulerConfig> {
    control: DayPilot.Scheduler;
}

export declare class DayPilotCalendar extends React.Component<DayPilot.CalendarConfig> {
    control: DayPilot.Calendar;
}

export declare class DayPilotMonth extends React.Component<DayPilot.MonthConfig> {
    control: DayPilot.Month;
}

export declare class DayPilotGantt extends React.Component<DayPilot.GanttConfig> {
    control: DayPilot.Gantt;
}

export declare class DayPilotKanban extends React.Component<DayPilot.KanbanConfig> {
    control: DayPilot.Kanban;
}

export declare class DayPilotNavigator extends React.Component<DayPilot.NavigatorConfig> {
    control: DayPilot.Navigator;
}

export declare class DayPilotQueue extends React.Component<DayPilot.QueueConfig> {
    control: DayPilot.Queue;
}
